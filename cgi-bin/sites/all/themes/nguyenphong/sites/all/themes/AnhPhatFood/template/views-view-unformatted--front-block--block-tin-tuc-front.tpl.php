        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xl-6 col-6 align-self-center text-left text-lg-right">
                    <a href="/chuyen-muc-bai-viet/tin-tuc" class="btn-danger-edit pdr-20 pdl-20 pdt-10 pdb-10 btn-gradient-color btn-md"><i class="fa fa-angle-double-right mrr-10" aria-hidden="true"></i>XEM TẤT CẢ</a>
                </div>
            </div>
        </div>
    </div>
