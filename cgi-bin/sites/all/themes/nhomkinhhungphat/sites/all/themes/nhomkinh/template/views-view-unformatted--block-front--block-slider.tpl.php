<?php /*[field_image]{{}}[field_image_1]{{}}[field_caption]{{}}[field_mo_ta_slider]*/?>
                            ...
                            <div class="swiper-slide" style="background-image: url('<?=$field_image_1?>');">
                                            <div class="content-outer">
                                                <div class="content-box">
                                                    <div class="inner">
                                                        <h2>NHÔM KÍNH HƯNG PHÁT</h2>
                                                        <div class="text"><?=$field_caption?><br> <?=$field_mo_ta_slider?> </div>
                                                        <div class="link-box">
                                                            <a href="tel:0867596583" class="theme-btn btn-style-one light"><span>LIÊN HỆ</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
