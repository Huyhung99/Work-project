      ...
      <div class="input-group">
        <input class="form-control modified input-search-map" placeholder="Nhập địa chỉ, tọa độ cần tra cứu">
          <div class="input-group-prepend">
              <a href="#" class="input-group-text bg-white" id="btn-search"><i class="fa fa-search"></i></a>
          </div>
      </div>
      <a id="btn-loc-bds">
...
<div class="menu-mb">
    <a href="#" class="item-menu"><i class="fab fa-r-project"></i> Dự án</a>
    <a href="#" class="item-menu"><i class="far fa-plus-square"></i> Đăng tin</a>
    <a href="#" class="item-menu"><i class="fas fa-mobile-alt"></i> Liên hệ</a>
</div>
</div>
