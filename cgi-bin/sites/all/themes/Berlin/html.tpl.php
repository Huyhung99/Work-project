...
<?php print $scripts; ?>
<!--<script async src="https://www.googletagmanager.com/gtag/js?id=G-J2KY0B4985"></script>-->
<!--<script>-->
<!--    window.dataLayer = window.dataLayer || [];-->
<!--    function gtag(){dataLayer.push(arguments);}-->
<!--    gtag('js', new Date());-->
<!---->
<!--    gtag('config', 'G-J2KY0B4985');-->
<!--</script>-->
<div class="hotlinefix">
    <span class="phone"><a href="tel:0936944489">0936.944.489</a></span>
    <a href="tel:0936944489">
        <div class="circle-hotline"><span><img src="/sites/default/files/hotline.png" alt="Trung tâm Ngoại ngữ Berlin" title="Trung tâm Ngoại ngữ Berlin">
          </span>
        </div>
    </a>
    <span class="notify-box"><a href="#" class="notify">Ưu đãi khóa học</a></span>
    <a href="#" class="notify">
