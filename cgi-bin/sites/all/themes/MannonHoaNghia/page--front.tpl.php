...
<?php print $messages?>
  ...
  <div class="block-front-intro-school">
    <?php if($page['name_header']) print render($page['name_header']); ?>
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <?php if($page['gioi_thieu_left']) print render($page['gioi_thieu_left']); ?>
            </div>
          <div class="col-md-5">
            <?php if($page['gioi_thieu_right']) print render($page['gioi_thieu_right']); ?>
          </div>
        </div>
      </div>
    </div>
  </div>
  <?php if($page['hinh_anh_front']) print render($page['hinh_anh_front']); ?>
  <div class="cl-b">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <?php if($page['chi_se_cach_nuoi_day_con']) print render($page['chi_se_cach_nuoi_day_con']) ?>
        </div>
        <div class="col-md-6">
          <?php if($page['tin_tuc_su_kien']) print render($page['tin_tuc_su_kien']) ?>
        </div>
      </div>
    </div>
  </div>
  <div class="container mt-30">
     <div class="row">
       <div class="col-md-6">
         <?php if($page['Chia_se_nuoi_day_con_left']) print render($page['Chia_se_nuoi_day_con_left']); ?>
       </div>
       <div class="col-md-6">
         <?php if($page['Chia_se_nuoi_day_con_right']) print render($page['Chia_se_nuoi_day_con_right']); ?>
       </div>
     </div>
    <?php if($page['main-content-front-bottom']) print render($page['main-content-front-bottom']); ?>
  </div>
  <div class="footer">
