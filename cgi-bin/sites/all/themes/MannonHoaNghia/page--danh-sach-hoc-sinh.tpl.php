...
<div class="modal fade" id="form_tiem_kiem_pop_up_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width: 1000px;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center">Danh sách chọn học sinh</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="form_hs_nghi_hoc">
          <table class="table table-bordered table-striped">
            <thead>
            <tr>
              <th width="20%">Tên học sinh</th>
              <th width="30%">Tên phụ huynh</th>
              <th width="20%">Ngày nghỉ</th>
              <th width="40%">Ghi chú/ Lý do nghỉ</th>
            </tr>
            </thead>
            <tbody>
          ...
          <p class="text-center"><a href="#" class="btn btn-success d-none hs-nghi-hoc">Nghỉ học</a></p>
        </form>
        <div class="load_du_lieu_nghi_hoc d-none">
          <div class="text-center"><div class="spinner-border text-danger" role="status">
              <span class="sr-only">Loading...</span>
...
<div class="modal fade" id="form_tiem_kiem_pop_up_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width: 800px;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="lop_nam mb-10"> <div class="load_du_lieu_chuyen_lop"><div class="text-center"><div class="spinner-border text-danger" role="status">
                <span class="sr-only">Loading...</span>
              </div><p class="mt-15 mb-0">Dữ liệu đang được xử lý</p></div></div></div>
        <form class="form_hs_chuyen_lop d-none">
          <div class="lop_nam_edit mb-10"></div>
          <table class="table table-bordered table-striped">
            <thead>
            <tr>
              <th width="20%">Tên học sinh</th>
              <th width="30%">Tên phụ huynh</th>
              <th width="20%">Lớp hiện tại</th>
            </tr>
            </thead>
            <tbody>
          ...
          <p class="text-center"><a href="#" class="btn mt-10 btn-success d-none hs_chuyen_lop">Chuyển lớp học</a></p>
        </form>
        <div class="load_du_lieu d-none">
          <div class="text-center"><div class="spinner-border text-danger" role="status">
              <span class="sr-only">Loading...</span>
            </div><p class="mt-15 mb-0">Dữ liệu đang được xử lý</p></div>
        </div>
