...
//        $objDrawing->setWidthAndHeight($width, $height);
    ...
    public static function alignVerticalLeft($activeSheet, $range){
      $activeSheet->getStyle($range)->getAlignment()->applyFromArray(
        array('vertical' => \PHPExcel_Style_Alignment::VERTICAL_LEFT,)
      );
    }
    /**
     * @param $activeSheet \PHPExcel_Worksheet
    ...
    /**
     * @param $objWorkSheet \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
