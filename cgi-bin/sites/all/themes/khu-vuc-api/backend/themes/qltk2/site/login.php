...
<head>
    <meta charset="utf-8"/>
    <title>FAST24H - HỆ THỐNG QUẢN LÝ ĐƠN HÀNG</title>
...
<div class="content">
    ...
    <div class="form-group">
        ...
        <?=Html::activeTextInput($model, 'username',['autofocus' => true, 'class' => 'form-control form-control-solid placeholder-no-fix', 'autocomplete' => 'new-password', 'placeholder' => 'Tên đăng nhập'])?>
    ...
    <div class="create-account">
        <p>
            <?= Html::a('ĐĂNG KÝ TÀI KHOẢN', \yii\helpers\Url::toRoute(['site/signup']))?>
        </p>
    </div>
...
<div class="copyright">
    <?=date("Y"); ?> © FAST24H - HỆ THỐNG QUẢN LÝ ĐƠN HÀNG<sup>™</sup>
</div>
<!-- END LOGIN -->
