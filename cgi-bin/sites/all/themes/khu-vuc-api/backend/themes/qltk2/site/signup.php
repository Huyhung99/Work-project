...
<head>
    <meta charset="utf-8"/>
    <title> ĐĂNG KÝ TÀI KHOẢN FS24H.COM</title>
...
<div class="logo">
    <a href="#" style="font-size: 18pt; text-decoration: none">
         ĐĂNG KÝ TÀI KHOẢN<br/>FS24H.COM
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <?php $form = ActiveForm::begin(['id' => 'signup-form', 'options' => ['class' => 'login-form']]); ?>
    ...
    <?=$form->field($signup, 'biet_den_ocv_qua_dau')->dropDownList([
        'Facebook' => 'Facebook',
        'Google' => 'Google',
        'Zalo' => 'Zalo',
        'Nhân viên kinh doanh' => 'Nhân viên kinh doanh',
        'Giới thiệu' => 'Giới thiệu',
        'Khác' => 'Khác'], ['prompt' => 'Bạn biết đến FS24H từ đâu?'])->label('Bạn biết đến FS24H từ đâu?',['class' => 'control-label visible-ie8 visible-ie9']);?>
    <div class="form-group field-signupform-lua-chon-khac hidden">
        <label class="control-label visible-ie8 visible-ie9" for="signupform-biet_den_ocv_qua_dau_khac"></label>
        <input type="text" id="signupform-biet_den_ocv_qua_dau_khac" class="form-control" name="SignupForm[biet_den_ocv_qua_dau_khac]" placeholder="Thông tin khác">
    ...
    <div class="form-group margin-top-20 margin-bottom-20">
        <label class="check">
            ...
            <a href="http://FS24H.COM/dieu-khoan" target="_blank" title="Các điều khoản tại FS24H" class="loginblue-link">các điều khoản được đưa ra</a>
        </label>
        <div id="register_tnc_error"></div>
    </div>
    <div class="form-actions">
        <a href="<?=\yii\helpers\Url::toRoute(['site/login'])?>" class="btn btn-default btn-dang-nhap">Quay lại đăng nhập</a>
...
<div class="copyright">
    <a href="https://minhhien.com.vn" target="_blank">Bản quyền thuộc về FS24H.COM</a>
</div>
<!-- END LOGIN -->
