      ...
      $(document).ready(function () {
        ...
        win.on('scroll', function() {
          ...
          if (scroll < 200) {
            ...
            $("#main_mb").removeClass("sticky");
          } else {
            $("#main_h").addClass("sticky");
            $("#main_mb").addClass("sticky");
          }
        });*/
        /*----------------------------
          MagnificPopup
        ...
        $(document).on("click", '.click_menu',function () {
          if($(this).parents('li').find('.megamenu').hasClass('d-none'))
          {
            $(this).parents('li').find('.megamenu').removeClass('d-none');
          }
          else {
            $(this).parents('li').find('.megamenu').addClass('d-none');
          }
        })
        ...
        $('.view-display-id-block_tat_ca_san_pham_front .top-interesting-active').owlCarousel({
          loop: true,
          autoplay: false,
          nav: true,
          navText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
        ...
        ------------------------------ */
        $('.show_room .new-product-home-2-active').owlCarousel({
          loop: true,
          autoplay: true,
          nav: false,
          slideSpeed: 200,
...
------------------------------ */
      ...
      $('select[name="attributes[field_gia_phu]"]').addClass('form-control');

      //handle product category
      var pdt = $('.page-category-product').css('padding-top');
      $('.btn-read-more').on('click',function (){
        var height = Number($('.page-category-product').css('padding-top').replace("px","")) + $('.product-category').height();
