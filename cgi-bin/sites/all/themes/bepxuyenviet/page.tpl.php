...
<div class="main-wrapper">
  ...
  <?php print $messages; ?>
            ...
            <div class="row">
                ...
                <div class="col-md-<?= $col?> order-1">
                    <div class="categories-names">
                        <?php print views_embed_view('danh_muc_loai_san_pham','block_categories_content')?>
                    </div>
                        <?php if (arg(2) != null&& is_numeric(arg(2))){
                            ...
                            print '<div class="fade-out"></div>';
                            print '</div>';
                            print '<p class="read-more text-center"><a href="#" class="button btn btn-primary">Xem thêm</a></p>';
                        } ?>
                    <?php if(!$page['col_5']):?>
    ...
    <div class="d-none"><?php print render($page['col_5'])?></div>
    <!-- footer-area-end -->
