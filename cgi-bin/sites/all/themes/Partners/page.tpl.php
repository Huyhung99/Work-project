        ...
        <div class="blog-items">
            <div class="row">
                ...
                <?php if ($page['sidebar_first']):?>
                    <?php $col = 8?>
                <?php endif;?>
                <div class="blog-content col-lg-<?=$col?> col-md-<?=$col?>">
                    <?php print $messages?>
                ...
                <?php if ($page['sidebar_first']):?>
                    ...
                    <div class="sidebar col-lg-4 col-md-12">
                        <aside>
                            <?php print str_replace('<p>{{tim-kiem}}</p>','<div class="sidebar-item search">
                               <div class="sidebar-info">
                                    <form action="search" method="get">
                                        <input type="text" name="title" placeholder="'.$placeholder.'" class="form-control">
