...
<?php if ($page['main_content_front']) print html_entity_decode(render($page['main_content_front']));?>
<section class="pdb-110 pdt-50 pdt-sm-30 pdb-sm-40 background-size-cover mt-50" data-background="/sites/default/files/shutterstock_1431782426_0.jpg" data-overlay-dark="8">
    <div class="section-content">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="popup-video-block video-popup">
                      <img class="img-full d-none d-lg-block" src="/sites/default/files/limestone.jpeg" alt="Công ty TNHH đầu tư phát triển và xuất nhập khẩu">
                        <a href="https://www.youtube.com/watch?v=8E3JHFI_kis" class="popup-video popup-youtube">
                ...
                <div class="col-lg-4 mrb-sm-110">
                    <div class="request-a-call-back-form">
                        ...
                        <p class="mrb-30">Thái Sơn chúng tôi đã luôn là thương hiệu tin tưởng tuyệt đối của các đối tác và khách hàng thân quý.</p>
                        <?php
    ...
    <div class="footer-main-area" data-background="/sites/all/themes/AnhPhatFood/assets/images/footer-bg.png">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                  <h5 class="widget-title text-white mrb-30">BẢN ĐỒ</h5>
